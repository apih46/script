...
cd /usr/bin
wget -O mss "https://raw.githubusercontent.com/apih46/script/main/SS/mss.sh"
wget -O add-ss "https://raw.githubusercontent.com/apih46/script/main/SS/add-ss.sh"
wget -O del-ss "https://raw.githubusercontent.com/apih46/script/main/SS/del-ss.sh"
wget -O cek-ss "https://raw.githubusercontent.com/apih46/script/main/SS/cek-ss.sh"
wget -O renew-ss "https://raw.githubusercontent.com/apih46/script/main/SS/renew-ss.sh"
chmod +x mss
chmod +x add-ss
chmod +x del-ss
chmod +x cek-ss
